...
tape( 'the function invokes a reduction function for each element in an array (complex number array)', function test( t ) {
	...
	actual = reduce( arr, new Complex64( 0.0, 0.0 ), f );
